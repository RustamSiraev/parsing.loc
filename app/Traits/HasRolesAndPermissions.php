...
trait HasRolesAndPermissions
{
     ...
     * из своих ролей?
     */
    public function hasPermViaRoles(Permission $permission): bool
    {
     ...
     */
    public function hasPermAnyWay(Permission $permission): bool
    {
     ...
     */
    public function getAllPermsViaRoles(): array
    {
     ...
     */
    public function getAllPermsAnyWay(): array
    {
        $perms = array_merge(
            $this->getAllPerms(),

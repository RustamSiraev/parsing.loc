...
@section('content')
    <div class="page-title">
        ...
        <div class="form-group" style="width: 300px">
            <select name="speciality_id" class="speciality-select form-control" title="Специальность">
            </select>
        </div>
    </div>
    <div class="">
        <table class="table table-secondary table-bordered college-statistic-table table-striped" style="width:100%" id="employee_data">
            <thead>
            <tr>
                <th>Показатель</th>
                <th>Значение</th>
